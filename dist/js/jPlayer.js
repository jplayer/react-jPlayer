...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var actionNames = exports.actionNames = {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.convertTime = exports.canSetVolume = exports.limitValue = exports.getHeight = exports.getWidth = exports.getOffset = exports.urlNotSetError = exports.urlNotSupportedError = exports.InvalidGlobalMethodException = exports.noFormatSupportedError = exports.updateObject = exports.traverseParentsUntilClassName = exports.toRelativePercentage = exports.toPercentage = exports.connectWithId = undefined;var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};var _react = __webpack_require__(0);var _react2 = _interopRequireDefault(_react);
var _reactRedux = __webpack_require__(10);
var _getContext = __webpack_require__(58);var _getContext2 = _interopRequireDefault(_getContext);
var _compose = __webpack_require__(57);var _compose2 = _interopRequireDefault(_compose);

var _constants = __webpack_require__(1);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}

var connectWithId = exports.connectWithId = function connectWithId() {return (0, _compose2.default)(
  (0, _getContext2.default)({ id: _react2.default.PropTypes.string }),
  _reactRedux.connect.apply(undefined, arguments));};


var toPercentage = exports.toPercentage = function toPercentage(number, max) {return 100 * (number / max);};
var toRelativePercentage = exports.toRelativePercentage = function toRelativePercentage(number, max) {return number * (max / 100);};
...
var noFormatSupportedError = exports.noFormatSupportedError = function noFormatSupportedError(context) {return {
    ...
    hint: _constants.hints.FORMAT_NO_SUPPORT };};var


InvalidGlobalMethodException = exports.InvalidGlobalMethodException =
function InvalidGlobalMethodException(context) {_classCallCheck(this, InvalidGlobalMethodException);
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.setFocus = exports.setFullScreen = exports.setLoop = exports.setPlaybackRate = exports.setDuration = exports.setMute = exports.setVolume = exports.setPlayHead = exports.pause = exports.play = exports.clearMedia = exports.setMedia = exports.setOption = undefined;var _constants = __webpack_require__(1);

var setOption = exports.setOption = function setOption(key, value, id) {return {
    type: _constants.actionNames.SET_OPTION,
    key: key,
    value: value,
    id: id };};

var setMedia = exports.setMedia = function setMedia(media, id) {return {
    type: _constants.actionNames.SET_MEDIA,
    media: media,
    id: id };};

var clearMedia = exports.clearMedia = function clearMedia(id) {return {
    type: _constants.actionNames.CLEAR_MEDIA,
    id: id };};

var play = exports.play = function play(time, id) {return {
    type: _constants.actionNames.PLAY,
    time: time,
    id: id };};

var pause = exports.pause = function pause(time, id) {return {
    type: _constants.actionNames.PAUSE,
    time: time,
    id: id };};

var setPlayHead = exports.setPlayHead = function setPlayHead(percent, id) {return {
    type: _constants.actionNames.PLAY_HEAD,
    percent: percent,
    id: id };};

var setVolume = exports.setVolume = function setVolume(volume, id) {return {
    type: _constants.actionNames.VOLUME,
    volume: volume,
    id: id };};

var setMute = exports.setMute = function setMute(mute, id) {return {
    type: _constants.actionNames.MUTE,
    mute: mute,
    id: id };};

var setDuration = exports.setDuration = function setDuration(remainingDuration, id) {return {
    type: _constants.actionNames.DURATION,
    remainingDuration: remainingDuration,
    id: id };};

var setPlaybackRate = exports.setPlaybackRate = function setPlaybackRate(playbackRate, id) {return {
    type: _constants.actionNames.PLAYBACK_RATE,
    playbackRate: playbackRate,
    id: id };};

var setLoop = exports.setLoop = function setLoop(loop, id) {return {
    type: _constants.actionNames.LOOP,
    loop: loop,
    id: id };};

var setFullScreen = exports.setFullScreen = function setFullScreen(fullScreen, id) {return {
    type: _constants.actionNames.FULL_SCREEN,
    fullScreen: fullScreen,
    id: id };};

var setFocus = exports.setFocus = function setFocus(id) {return {
...
var _index = __webpack_require__(2);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self, call) {if (!self) {throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call && (typeof call === "object" || typeof call === "function") ? call : self;}function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function, not " + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } });if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass;}

var mapStateToProps = function mapStateToProps(_ref, _ref2) {var jPlayers = _ref.jPlayers;var id = _ref2.id;return {
    barDrag: jPlayers[id].barDrag };};var
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};var _index = __webpack_require__(2);
var _playbackRateBarValue = __webpack_require__(45);var _playbackRateBarValue2 = _interopRequireDefault(_playbackRateBarValue);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;}

var mapStateToProps = function mapStateToProps(_ref2, _ref) {var jPlayers = _ref2.jPlayers;var id = _ref.id,attributes = _objectWithoutProperties(_ref, ['id']);return _extends({
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};var _index = __webpack_require__(2);
var _volumeBarValue = __webpack_require__(52);var _volumeBarValue2 = _interopRequireDefault(_volumeBarValue);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;}
...
var _actions = __webpack_require__(3);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self, call) {if (!self) {throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call && (typeof call === "object" || typeof call === "function") ? call : self;}function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function, not " + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } });if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass;}

var mapStateToProps = function mapStateToProps(_ref, _ref2) {var jPlayers = _ref.jPlayers;var id = _ref2.id,children = _ref2.children;return {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, _ref3) {var id = _ref3.id;return {
    setOption: function setOption(key, value) {return dispatch((0, _actions.setOption)(key, value, id));},
    pause: function pause(time) {return dispatch((0, _actions.pause)(time, id));} };};var
  ...
  function MediaContainer(props) {_classCallCheck(this, MediaContainer);var _this = _possibleConstructorReturn(this, (MediaContainer.__proto__ || Object.getPrototypeOf(MediaContainer)).call(this,
    ...
    getCurrentPercentRelative = function () {
      ...
      if (_this.currentMedia.seekable.length > 0) {
        currentPercentRelative = (0, _index.toPercentage)(_this.currentMedia.currentTime,
        _this.getSeekableEnd());
      }
      return currentPercentRelative;
    };_this.
    setCurrentMedia = function (ref) {
      _this.currentMedia = ref;
    };_this.
    getSeekableEnd = function () {return _this.currentMedia.seekable.end(_this.currentMedia.seekable.length - 1);};_this.
    updateMediaStatus = function () {
      ...
      var currentPercentAbsolute = (0, _index.toPercentage)(_this.currentMedia.currentTime,
    ...
    updateCurrentMedia = function (_ref4)
    {var defaultPlaybackRate = _ref4.defaultPlaybackRate,playbackRate = _ref4.playbackRate,preload = _ref4.preload,volume = _ref4.volume,muted = _ref4.muted,autoplay = _ref4.autoplay,loop = _ref4.loop;
      ...
      _this.currentMedia.loop = loop;
        ...
        _this.props.pause(0);_this.updateMediaStatus();if (_this.props.loop) {_this.props.onRepeat();}_this.props.onEnded();}, onError: function onError() {_this.props.setOption('error', (0, _index.urlNotSupportedError)(_this.props.src));_this.props.onError();}, onRateChange: _this.props.onRateChange, onPlaying: _this.props.onPlaying, onPause: _this.props.onPause, onWaiting: _this.props.onWaiting, onSuspend: _this.props.onSuspend, onVolumeChange: _this.props.onVolumeChange, onLoadStart: _this.props.onLoadStart, onLoadedMetadata: _this.props.onLoadedMetadata, onAbort: _this.props.onAbort, onEmptied: _this.props.onEmptied, onStalled: _this.props.onStalled, onLoadedData: _this.props.onLoadedData, onCanPlay: _this.props.onCanPlay, onCanPlayThrough: _this.props.onCanPlayThrough };return _this;}_createClass(MediaContainer, [{ key: 'componentDidMount', value: function componentDidMount() {this.currentMedia.src = this.props.src;this.props.setOption('volumeSupported', (0, _index.canSetVolume)());this.updateCurrentMedia(this.props);} }, { key: 'componentWillReceiveProps', value: function componentWillReceiveProps(nextProps) {this.updateCurrentMedia(nextProps);if (nextProps.src !== this.props.src) {this.currentMedia.src = nextProps.src;}if (nextProps.newTime !== null) {this.currentMedia.currentTime = nextProps.newTime;this.props.setOption('newTime', null);}if (nextProps.playHeadPercent !== this.props.playHeadPercent) {// TODO: Investigate why some .mp3 urls don't fire media events enough (http://www.davidgagne.net/m/song.mp3).
        // Hasn't fully loaded the song????
        if (this.currentMedia.seekable.length > 0) {this.currentMedia.currentTime = (0, _index.toRelativePercentage)(nextProps.playHeadPercent, this.getSeekableEnd()); // Media events don't fire fast enough to give a smooth animation when dragging so we update it here as well, same problem as above?
...
(0, _index.connectWithId)(mapStateToProps, mapDispatchToProps)(MediaContainer);
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _index = __webpack_require__(2);
var _browserUnsupported = __webpack_require__(34);var _browserUnsupported2 = _interopRequireDefault(_browserUnsupported);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

var mapStateToProps = function mapStateToProps(_ref, _ref2) {var jPlayers = _ref.jPlayers;var id = _ref2.id,children = _ref2.children;return {
    foundSupported: jPlayers[id].mediaSettings.foundSupported,
    children: children };};exports.default =
...
var _index = __webpack_require__(2);
var _bufferBar = __webpack_require__(35);var _bufferBar2 = _interopRequireDefault(_bufferBar);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self, call) {if (!self) {throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call && (typeof call === "object" || typeof call === "function") ? call : self;}function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function, not " + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } });if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass;}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;}

var mapStateToProps = function mapStateToProps(_ref2, _ref) {var jPlayers = _ref2.jPlayers;var id = _ref.id,attributes = _objectWithoutProperties(_ref, ['id']);return {
...
BufferBarContainer = function (_React$Component) {_inherits(BufferBarContainer, _React$Component);function BufferBarContainer() {var _ref3;var _temp, _this, _ret;_classCallCheck(this, BufferBarContainer);for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {args[_key] = arguments[_key];}return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref3 = BufferBarContainer.__proto__ || Object.getPrototypeOf(BufferBarContainer)).call.apply(_ref3, [this].concat(args))), _this), _this.
    ...
    } }], [{ key: 'propTypes', get: function get() {return { attributes: _react2.default.PropTypes.object, bufferedTimeRanges: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.shape({ start: _react2.default.PropTypes.number.isRequired, end: _react2.default.PropTypes.number.isRequired })).isRequired, /* eslint-disable react/no-unused-prop-types */bufferColour: _react2.default.PropTypes.string.isRequired, duration: _react2.default.PropTypes.number.isRequired };} }, { key: 'defaultProps', get: function get() {return { attributes: null };} }]);return BufferBarContainer;}(_react2.default.Component);exports.default =
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};var _index = __webpack_require__(2);
var _currentTime = __webpack_require__(36);var _currentTime2 = _interopRequireDefault(_currentTime);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;}

var mapStateToProps = function mapStateToProps(_ref2, _ref) {var jPlayers = _ref2.jPlayers;var id = _ref.id,children = _ref.children,attributes = _objectWithoutProperties(_ref, ['id', 'children']);return _extends({
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};var _index = __webpack_require__(2);
var _duration = __webpack_require__(38);var _duration2 = _interopRequireDefault(_duration);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;}
...
var _fullScreen = __webpack_require__(39);var _fullScreen2 = _interopRequireDefault(_fullScreen);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;}

var mapStateToProps = function mapStateToProps(_ref, _ref2) {var jPlayers = _ref.jPlayers;var id = _ref2.id;return {
    fullScreen: jPlayers[id].fullScreen };};


var mergeProps = function mergeProps(_ref4, _ref5, _ref3) {var fullScreen = _ref4.fullScreen;var dispatch = _ref5.dispatch;var id = _ref3.id,attributes = _objectWithoutProperties(_ref3, ['id']);return _extends({
    onClick: function onClick() {return dispatch((0, _actions.setFullScreen)(!fullScreen, id));} },
...
Object.defineProperty(exports, "__esModule", { value: true });var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};var _index = __webpack_require__(2);
var _actions = __webpack_require__(3);
var _gui = __webpack_require__(40);var _gui2 = _interopRequireDefault(_gui);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;}
...
var mergeProps = function mergeProps(stateProps, _ref4, _ref3) {var dispatch = _ref4.dispatch;var id = _ref3.id,attributes = _objectWithoutProperties(_ref3, ['id']);return _extends({
    onMouseMove: function onMouseMove() {
      if (stateProps.fullScreen && !stateProps.paused) {
        dispatch((0, _actions.setOption)('guiFadeOut', false, id));
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;};}();var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};var _react = __webpack_require__(0);var _react2 = _interopRequireDefault(_react);
var _screenfull = __webpack_require__(59);var _screenfull2 = _interopRequireDefault(_screenfull);
var _classnames = __webpack_require__(55);var _classnames2 = _interopRequireDefault(_classnames);

var _index = __webpack_require__(2);
var _constants = __webpack_require__(1);
var _jPlayer = __webpack_require__(41);var _jPlayer2 = _interopRequireDefault(_jPlayer);
...
var mapStateToProps = function mapStateToProps(_ref2, _ref) {var _classNames;var jPlayers = _ref2.jPlayers;var id = _ref.id,children = _ref.children,attributes = _objectWithoutProperties(_ref, ['id', 'children']);return {
    ...
    attributes, {
      ...
      _constants.classes.states.AUDIO, !jPlayers[id].mediaSettings.video), _defineProperty(_classNames,
      _constants.classes.states.VIDEO, jPlayers[id].mediaSettings.video), _defineProperty(_classNames,
      _constants.classes.states.PLAYING, !jPlayers[id].paused), _defineProperty(_classNames,
      _constants.classes.states.IDLE, jPlayers[id].currentTime === 0), _defineProperty(_classNames,
      _constants.classes.states.FULL_SCREEN, jPlayers[id].fullScreen), _defineProperty(_classNames,
      _constants.classes.states.MUTED, jPlayers[id].muted), _defineProperty(_classNames,
      _constants.classes.states.VOLUME_LOW, !jPlayers[id].muted && jPlayers[id].volume < 0.5), _defineProperty(_classNames,
      _constants.classes.states.VOLUME_HIGH, !jPlayers[id].muted && jPlayers[id].volume >= 0.5), _defineProperty(_classNames,
      _constants.classes.states.SEEKING, jPlayers[id].seeking), _defineProperty(_classNames,
      _constants.classes.states.LOOPED, jPlayers[id].loop), _defineProperty(_classNames,
      _constants.classes.states.NO_BROWSER_SUPPORT, !jPlayers[id].mediaSettings.foundSupported), _defineProperty(_classNames,
      _constants.classes.states.NO_VOLUME_SUPPORT, !jPlayers[id].volumeSupported), _classNames)) }) };};




var mergeProps = function mergeProps(stateProps, _ref3, _ref4) {var dispatch = _ref3.dispatch;var id = _ref4.id;return _extends({
    setMedia: function setMedia(media) {return dispatch((0, _actions.setMedia)(media, id));},
    setOption: function setOption(key, value) {return dispatch((0, _actions.setOption)(key, value, id));} },
  stateProps);};var


JPlayerContainer = function (_React$Component) {_inherits(JPlayerContainer, _React$Component);function JPlayerContainer() {var _ref5;var _temp, _this, _ret;_classCallCheck(this, JPlayerContainer);for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {args[_key] = arguments[_key];}return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref5 = JPlayerContainer.__proto__ || Object.getPrototypeOf(JPlayerContainer)).call.apply(_ref5, [this].concat(args))), _this), _this.
    ...
    setFullScreen = function (_ref6) {var fullScreen = _ref6.fullScreen;
      if (fullScreen) {
    ...
    startGuiFadeOutTimer = function () {
      if (_this.props.fullScreen && !_this.props.paused) {
        ...
        _this.props.setOption('guiFadeHoldTimeout', setTimeout(_this.startGuiFadeOut,
    ...
    logError = function (_ref7) {var error = _ref7.error;return console.error(error);}, _temp), _possibleConstructorReturn(_this, _ret);}_createClass(JPlayerContainer, [{ key: 'componentWillMount', value: function componentWillMount() {if (_screenfull2.default.enabled) {document.addEventListener(_screenfull2.default.raw.fullscreenchange, this.closeFullScreen);}} }, { key: 'componentDidMount', value: function componentDidMount() {this.props.setMedia(this.props.media);} }, { key: 'componentWillReceiveProps', value: function componentWillReceiveProps(nextProps) {if (nextProps.error !== this.props.error) {this.logError(nextProps);}if (nextProps.fullScreen !== this.props.fullScreen) {this.setFullScreen(nextProps);}} }, { key: 'componentDidUpdate', value: function componentDidUpdate(prevProps) {if (prevProps.paused !== this.props.paused) {this.startGuiFadeOutTimer();}} }, { key: 'componentWillUnmount', value: function componentWillUnmount() {if (_screenfull2.default.enabled) {document.removeEventListener(_screenfull2.default.raw.fullscreenchange, this.closeFullScreen);}} // eslint-disable-next-line no-console
    ...
    } }], [{ key: 'propTypes', get: function get() {return { attributes: _react2.default.PropTypes.object, media: _react2.default.PropTypes.shape({ title: _react2.default.PropTypes.string, artist: _react2.default.PropTypes.string, sources: _react2.default.PropTypes.shape(formatPropTypes).isRequired, poster: _react2.default.PropTypes.string, free: _react2.default.PropTypes.bool }).isRequired, setOption: _react2.default.PropTypes.func.isRequired, setMedia: _react2.default.PropTypes.func.isRequired, error: _react2.default.PropTypes.shape({ context: _react2.default.PropTypes.string, message: _react2.default.PropTypes.string, hint: _react2.default.PropTypes.string }).isRequired, fullScreen: _react2.default.PropTypes.bool.isRequired, children: _react2.default.PropTypes.oneOfType([_react2.default.PropTypes.arrayOf(_react2.default.PropTypes.element), _react2.default.PropTypes.element]).isRequired, keyEnabled: _react2.default.PropTypes.bool.isRequired, paused: _react2.default.PropTypes.bool.isRequired, guiFadeHoldTime: _react2.default.PropTypes.number.isRequired, guiFadeHoldTimeout: _react2.default.PropTypes.number };} }, { key: 'defaultProps', get: function get() {return { attributes: null, guiFadeHoldTimeout: null };} }]);return JPlayerContainer;}(_react2.default.Component);exports.default =
...
Object.defineProperty(exports, "__esModule", { value: true });var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};var _index = __webpack_require__(2);
var _actions = __webpack_require__(3);
var _mute = __webpack_require__(42);var _mute2 = _interopRequireDefault(_mute);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;}

var mapStateToProps = function mapStateToProps(_ref, _ref2) {var jPlayers = _ref.jPlayers;var id = _ref2.id;return {
    muted: jPlayers[id].muted };};


var mergeProps = function mergeProps(_ref4, _ref5, _ref3) {var muted = _ref4.muted;var dispatch = _ref5.dispatch;var id = _ref3.id,attributes = _objectWithoutProperties(_ref3, ['id']);return _extends({
    onClick: function onClick() {return dispatch((0, _actions.setMute)(!muted, id));} },
  attributes);};exports.default =
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};var _index = __webpack_require__(2);
var _playBar = __webpack_require__(43);var _playBar2 = _interopRequireDefault(_playBar);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;}
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};var _actions = __webpack_require__(3);
var _index = __webpack_require__(2);
var _play = __webpack_require__(44);var _play2 = _interopRequireDefault(_play);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;}

var mapStateToProps = function mapStateToProps(_ref, _ref2) {var jPlayers = _ref.jPlayers;var id = _ref2.id;return {
    paused: jPlayers[id].paused };};


var mergeProps = function mergeProps(_ref4, _ref5, _ref3) {var paused = _ref4.paused;var dispatch = _ref5.dispatch;var id = _ref3.id,attributes = _objectWithoutProperties(_ref3, ['id']);return _extends({
    onClick: function onClick() {return paused ? dispatch((0, _actions.play)(undefined, id)) :
      dispatch((0, _actions.pause)(undefined, id));} },
  attributes);};exports.default =
...
var _index = __webpack_require__(2);
var _actions = __webpack_require__(3);
var _barEvents = __webpack_require__(4);var _barEvents2 = _interopRequireDefault(_barEvents);
var _playbackRateBar = __webpack_require__(46);var _playbackRateBar2 = _interopRequireDefault(_playbackRateBar);
var _playbackRateBarValueContainer = __webpack_require__(5);var _playbackRateBarValueContainer2 = _interopRequireDefault(_playbackRateBarValueContainer);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;}

var mapStateToProps = function mapStateToProps(_ref2, _ref) {var jPlayers = _ref2.jPlayers;var id = _ref.id,attributes = _objectWithoutProperties(_ref, ['id']);return {
    movePlaybackRate: function movePlaybackRate(bar, dispatch, e) {var _jPlayers$id =

      jPlayers[id],verticalPlaybackRate = _jPlayers$id.verticalPlaybackRate,minPlaybackRate = _jPlayers$id.minPlaybackRate,maxPlaybackRate = _jPlayers$id.maxPlaybackRate;
      ...
      dispatch((0, _actions.setPlaybackRate)(playbackRateValue, id));
    },
    attributes: attributes };};


var mergeProps = function mergeProps(_ref3, _ref4) {var movePlaybackRate = _ref3.movePlaybackRate,attributes = _ref3.attributes;var dispatch = _ref4.dispatch;return {
    onClick: function onClick(bar, e) {return movePlaybackRate(bar, dispatch, e);},
...
var PlaybackRateBarContainer = function PlaybackRateBarContainer(_ref5) {var onClick = _ref5.onClick,onTouch = _ref5.onTouch,children = _ref5.children,attributes = _ref5.attributes;return (
    _react2.default.createElement(_barEvents2.default, {
...
PlaybackRateBarContainer.propTypes = {
  ...
  onTouch: _react2.default.PropTypes.func.isRequired };exports.default =
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};var _index = __webpack_require__(2);
var _poster = __webpack_require__(47);var _poster2 = _interopRequireDefault(_poster);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;}
...
Object.defineProperty(exports, "__esModule", { value: true });var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};var _index = __webpack_require__(2);
var _actions = __webpack_require__(3);
var _repeat = __webpack_require__(48);var _repeat2 = _interopRequireDefault(_repeat);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;}

var mapStateToProps = function mapStateToProps(_ref, _ref2) {var jPlayers = _ref.jPlayers;var id = _ref2.id;return {
    loop: jPlayers[id].loop };};


var mergeProps = function mergeProps(_ref4, _ref5, _ref3) {var loop = _ref4.loop;var dispatch = _ref5.dispatch;var id = _ref3.id,attributes = _objectWithoutProperties(_ref3, ['id']);return _extends({
    onClick: function onClick() {return dispatch((0, _actions.setLoop)(!loop, id));} },
  attributes);};exports.default =
...
var _actions = __webpack_require__(3);
var _barEvents = __webpack_require__(4);var _barEvents2 = _interopRequireDefault(_barEvents);
var _seekBar = __webpack_require__(49);var _seekBar2 = _interopRequireDefault(_seekBar);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;}
...
var mapStateToProps = function mapStateToProps(_ref2, _ref) {var jPlayers = _ref2.jPlayers;var id = _ref.id,attributes = _objectWithoutProperties(_ref, ['id']);return {
    ...
    movePlayHead: function movePlayHead(bar, dispatch, e) {
      ...
      dispatch((0, _actions.setPlayHead)(percentage, id));
    },
    attributes: attributes };};


// eslint-disable-next-line no-unused-vars
var mergeProps = function mergeProps(_ref3, _ref4) {var movePlayHead = _ref3.movePlayHead,seekPercent = _ref3.seekPercent,attributes = _ref3.attributes;var dispatch = _ref4.dispatch;return {
    onClick: function onClick(bar, e) {return movePlayHead(bar, dispatch, e);},
    onTouch: function onTouch(bar, e) {
      // Stop page scrolling
      e.preventDefault();
...
var SeekBarContainer = function SeekBarContainer(_ref5) {var onClick = _ref5.onClick,onTouch = _ref5.onTouch,seekPercent = _ref5.seekPercent,attributes = _ref5.attributes;return (
    _react2.default.createElement(_barEvents2.default, { clickMoveBar: onClick, touchMoveBar: onTouch },
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};var _index = __webpack_require__(2);
var _title = __webpack_require__(50);var _title2 = _interopRequireDefault(_title);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;}

var mapStateToProps = function mapStateToProps(_ref2, _ref) {var jPlayers = _ref2.jPlayers;var children = _ref.children,id = _ref.id,attributes = _objectWithoutProperties(_ref, ['children', 'id']);return _extends({
...
var _actions = __webpack_require__(3);
var _barEvents = __webpack_require__(4);var _barEvents2 = _interopRequireDefault(_barEvents);
var _volumeBar = __webpack_require__(53);var _volumeBar2 = _interopRequireDefault(_volumeBar);
var _volumeBarValueContainer = __webpack_require__(6);var _volumeBarValueContainer2 = _interopRequireDefault(_volumeBarValueContainer);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;}

var mapStateToProps = function mapStateToProps(_ref2, _ref) {var jPlayers = _ref2.jPlayers;var id = _ref.id,attributes = _objectWithoutProperties(_ref, ['id']);return {
    moveVolumeBar: function moveVolumeBar(bar, dispatch, e) {var
      verticalVolume = jPlayers[id].verticalVolume;
      var offset = (0, _index.getOffset)(bar);
      var x = e.pageX - offset.left;
      var w = (0, _index.getWidth)(bar);
      ...
      if (verticalVolume) {
        dispatch((0, _actions.setVolume)(y / h, id));
      } else {
        dispatch((0, _actions.setVolume)(x / w, id));
      }
    },
    attributes: attributes };};


var mergeProps = function mergeProps(_ref3, _ref4) {var moveVolumeBar = _ref3.moveVolumeBar,attributes = _ref3.attributes;var dispatch = _ref4.dispatch;return {
    onClick: function onClick(bar, e) {return moveVolumeBar(bar, dispatch, e);},
    onTouch: function onTouch(bar, e) {
      // Stop page scrolling
      e.preventDefault();
...
var VolumeBarContainer = function VolumeBarContainer(_ref5) {var onClick = _ref5.onClick,onTouch = _ref5.onTouch,children = _ref5.children,attributes = _ref5.attributes;return (
    _react2.default.createElement(_barEvents2.default, { clickMoveBar: onClick, touchMoveBar: onTouch },
...
var mapStateToProps = function mapStateToProps(_ref) {var jPlayers = _ref.jPlayers;return _extends({},
  jPlayers);};


var getActions = function getActions(dispatch, id) {return {
    setOption: function setOption(key, value) {return dispatch((0, _actions.setOption)(key, value, id));},
    setMedia: function setMedia(media) {return dispatch((0, _actions.setMedia)(media, id));},
    clearMedia: function clearMedia() {return dispatch((0, _actions.clearMedia)(id));},
    play: function play(time) {return dispatch((0, _actions.play)(time, id));},
    pause: function pause(time) {return dispatch((0, _actions.pause)(time, id));},
    setPlayHead: function setPlayHead(percent) {return dispatch((0, _actions.setPlayHead)(percent, id));},
    setVolume: function setVolume(volume) {return dispatch((0, _actions.setVolume)(volume, id));},
    setMute: function setMute(mute) {return dispatch((0, _actions.setMute)(mute, id));},
    setDuration: function setDuration(remainingDuration) {return dispatch((0, _actions.setDuration)(remainingDuration, id));},
    setPlaybackRate: function setPlaybackRate(playbackRate) {return dispatch((0, _actions.setPlaybackRate)(playbackRate, id));},
    setLoop: function setLoop(loop) {return dispatch((0, _actions.setLoop)(loop, id));},
    setFullScreen: function setFullScreen(fullScreen) {return dispatch((0, _actions.setFullScreen)(fullScreen, id));},
    setFocus: function setFocus() {return dispatch((0, _actions.setFocus)(id));} };};


var mergeProps = function mergeProps(jPlayers, _ref3, _ref2) {var dispatch = _ref3.dispatch;var id = _ref2.id,props = _objectWithoutProperties(_ref2, ['id']);
  var newJPlayers = {};
  ...
  Object.keys(jPlayers).forEach(function (jPlayerKey) {
    ...
    newJPlayers[jPlayerKey] = _extends({},
  ...
  jPlayer = newJPlayers[id],otherPlayers = _objectWithoutProperties(newJPlayers, [id]);

  var returnedJPlayers = _extends({},
  props,
  jPlayer);
...
var Connect = function Connect(jPlayer) {
  ...
  var playerName = jPlayer.name === undefined ?
  jPlayer.toString().match(/^function\s*([^\s(]+)/)[1] : jPlayer.name;

  return function (_React$Component) {_inherits(ConnectedJPlayer, _React$Component);function ConnectedJPlayer() {var _ref4;var _temp, _this, _ret;_classCallCheck(this, ConnectedJPlayer);for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {args[_key] = arguments[_key];}return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref4 = ConnectedJPlayer.__proto__ || Object.getPrototypeOf(ConnectedJPlayer)).call.apply(_ref4, [this].concat(args))), _this), _this.
      ...
      getChildContext = function () {return {
          id: playerName };}, _temp), _possibleConstructorReturn(_this, _ret);}_createClass(ConnectedJPlayer, [{ key: 'render', value: function render()

      {
        return _react2.default.createElement(ConnectedPlayer, _extends({ id: playerName }, this.props));
      } }], [{ key: 'id', get: function get() {return playerName;} }, { key: 'jPlayer', get: function get() {return jPlayer;} }, { key: 'childContextTypes', get: function get() {return { id: _react2.default.PropTypes.string };} }]);return ConnectedJPlayer;}(_react2.default.Component);
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};var _lodash = __webpack_require__(8);var _lodash2 = _interopRequireDefault(_lodash);

var _constants = __webpack_require__(1);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var getInitialStates = function getInitialStates(connectedJPlayers) {
  ...
  newConnectedJPlayers.forEach(function (connectedJPlayer) {
    jPlayerStates[connectedJPlayer.id] = (0, _lodash2.default)({}, _extends({}, _constants.internalStatus, _constants.defaultStatus, _constants.defaultOptions),
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};var _lodash = __webpack_require__(56);var _lodash2 = _interopRequireDefault(_lodash);

var _constants = __webpack_require__(1);
var _index = __webpack_require__(2);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}


var resetStatus = function resetStatus(state) {return (0, _index.updateObject)(state, _extends({}, _constants.defaultStatus));};
...
var setFocus = function setFocus(state, _ref11) {var id = _ref11.id;
...
var actionTypeValid = function actionTypeValid(actionType) {return (
    Object.keys(_constants.actionNames).some(function (currentActionType) {return currentActionType === actionType;}));};
...
var _mediaContainer = __webpack_require__(7);var _mediaContainer2 = _interopRequireDefault(_mediaContainer);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;}
...
var Audio = function Audio(_ref) {var require = _ref.require,events = _ref.events,attributes = _objectWithoutProperties(_ref, ['require', 'events']);return (
    require ?
    _react2.default.createElement(_mediaContainer2.default, events,
...
BrowserUnsupported.defaultProps = {
  ...
  _react2.default.createElement('div', { className: _constants.classes.NO_BROWSER_SUPPORT },
    ...
    _react2.default.createElement('div', null, 'Your browser does not support this media file. To play the media you will need to update your browser to a more recent version.')) };
...
BrowserUnsupported.propTypes = {
  children: _react2.default.PropTypes.node,
  foundSupported: _react2.default.PropTypes.bool.isRequired };exports.default =
...
var _constants = __webpack_require__(1);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;}
...
var CurrentTime = function CurrentTime(_ref) {var attributes = _objectWithoutProperties(_ref, []);return (
    _react2.default.createElement('div', _extends({}, attributes, { className: _constants.classes.CURRENT_TIME })));};
...
var motion = function motion(values, onMouseMove, attributes) {return (
...
var Gui = function Gui(_ref) {var fullScreen = _ref.fullScreen,guiFadeOut = _ref.guiFadeOut,onMouseMove = _ref.onMouseMove,attributes = _objectWithoutProperties(_ref, ['fullScreen', 'guiFadeOut', 'onMouseMove']);return (
    _react2.default.createElement(_reactMotion.Motion, {
        defaultStyle: { opacity: 1 },
        style: { opacity: fullScreen ? (0, _reactMotion.spring)(guiFadeOut ? 0 : 1, [250]) : 1 } },

      function (values) {return motion(values, onMouseMove, attributes);}));};
...
var _constants = __webpack_require__(1);
var _keyControlContainer = __webpack_require__(54);var _keyControlContainer2 = _interopRequireDefault(_keyControlContainer);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;}
...
var JPlayer = function JPlayer(_ref) {var keyEnabled = _ref.keyEnabled,setJPlayer = _ref.setJPlayer,children = _ref.children,attributes = _objectWithoutProperties(_ref, ['keyEnabled', 'setJPlayer', 'children']);return (
    _react2.default.createElement('div', _extends({}, attributes, { ref: setJPlayer, draggable: false }),
      children,
...
PlayBar.propTypes = {
  ...
  smoothPlayBar: _react2.default.PropTypes.bool.isRequired };exports.default =
...
var SeekBar = function SeekBar(_ref) {var setBar = _ref.setBar,onClick = _ref.onClick,onMouseDown = _ref.onMouseDown,onTouchStart = _ref.onTouchStart,
  seekPercent = _ref.seekPercent,attributes = _objectWithoutProperties(_ref, ['setBar', 'onClick', 'onMouseDown', 'onTouchStart', 'seekPercent']);return (
    _react2.default.createElement('div', _extends({},
...
var Title = function Title(_ref) {var children = _ref.children,artist = _ref.artist,title = _ref.title,attributes = _objectWithoutProperties(_ref, ['children', 'artist', 'title']);return (
...
Title.propTypes = {
  ...
  artist: _react2.default.PropTypes.oneOfType([
  _react2.default.PropTypes.string,
  _react2.default.PropTypes.number]),
...
var _mediaContainer = __webpack_require__(7);var _mediaContainer2 = _interopRequireDefault(_mediaContainer);
var _constants = __webpack_require__(1);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectWithoutProperties(obj, keys) {var target = {};for (var i in obj) {if (keys.indexOf(i) >= 0) continue;if (!Object.prototype.hasOwnProperty.call(obj, i)) continue;target[i] = obj[i];}return target;}
...
var VolumeBar = function VolumeBar(_ref) {var setBar = _ref.setBar,onClick = _ref.onClick,onMouseDown = _ref.onMouseDown,
  onTouchStart = _ref.onTouchStart,attributes = _objectWithoutProperties(_ref, ['setBar', 'onClick', 'onMouseDown', 'onTouchStart']);return (
    _react2.default.createElement('div', _extends({},
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;};}();var _react = __webpack_require__(0);var _react2 = _interopRequireDefault(_react);
var _lodash = __webpack_require__(8);var _lodash2 = _interopRequireDefault(_lodash);
...
var mergeProps = function mergeProps(stateProps, _ref3, _ref4) {var dispatch = _ref3.dispatch;var id = _ref4.id;return {
    focus: stateProps.focus,
    keyBindings: (0, _lodash2.default)({}, {
      play: {
        key: 80, // p
        fn: function fn() {return stateProps.paused ? dispatch((0, _actions.play)(undefined, id)) :
          dispatch((0, _actions.pause)(undefined, id));} },

      fullScreen: {
        key: 70, // f
        fn: function fn() {return dispatch((0, _actions.setFullScreen)(!stateProps.fullScreen, id));} },

      mute: {
        key: 77, // m
        fn: function fn() {return dispatch((0, _actions.setMute)(!stateProps.muted, id));} },

      volumeUp: {
        key: 190, // .
        fn: function fn() {
          dispatch((0, _actions.setVolume)(stateProps.volume + 0.1, id));
        } },

      volumeDown: {
        key: 188, // ,
        fn: function fn() {return dispatch((0, _actions.setVolume)(stateProps.volume - 0.1, id));} },

      loop: {
        key: 76, // l
        fn: function fn() {return dispatch((0, _actions.setLoop)(!stateProps.loop, id));} } },

    stateProps.keyBindings),
    id: id };};var


KeyControlContainer = function (_React$Component) {_inherits(KeyControlContainer, _React$Component);function KeyControlContainer() {var _ref5;var _temp, _this, _ret;_classCallCheck(this, KeyControlContainer);for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {args[_key] = arguments[_key];}return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref5 = KeyControlContainer.__proto__ || Object.getPrototypeOf(KeyControlContainer)).call.apply(_ref5, [this].concat(args))), _this), _this.
    ...
    }, _temp), _possibleConstructorReturn(_this, _ret);}_createClass(KeyControlContainer, [{ key: 'componentWillMount', value: function componentWillMount() {document.addEventListener('keydown', this.onKeyDown);} }, { key: 'componentWillUnmount', value: function componentWillUnmount() {document.removeEventListener('keydown', this.onKeyDown);} }, { key: 'render', value: function render()
    {
      return null;
    } }], [{ key: 'propTypes', get: function get() {return { focus: _react2.default.PropTypes.bool.isRequired, keyBindings: _react2.default.PropTypes.objectOf(_react2.default.PropTypes.object).isRequired };} }]);return KeyControlContainer;}(_react2.default.Component);exports.default =


(0, _index.connectWithId)(mapStateToProps, null, mergeProps)(KeyControlContainer);
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.BrowserUnsupported = exports.CurrentTime = exports.Duration = exports.Download = exports.VolumeBarValue = exports.VolumeBar = exports.PlaybackRateBarValue = exports.PlaybackRateBar = exports.Repeat = exports.Play = exports.Mute = exports.FullScreen = exports.Title = exports.Audio = exports.Video = exports.Poster = exports.BufferBar = exports.PlayBar = exports.SeekBar = exports.Gui = exports.JPlayer = exports.connect = exports.reducer = exports.getInitialStates = exports.classes = undefined;var _getInitialStates = __webpack_require__(31);var _getInitialStates2 = _interopRequireDefault(_getInitialStates);
var _reducer = __webpack_require__(32);var _reducer2 = _interopRequireDefault(_reducer);
var _connect = __webpack_require__(30);var _connect2 = _interopRequireDefault(_connect);
var _guiContainer = __webpack_require__(18);var _guiContainer2 = _interopRequireDefault(_guiContainer);
var _videoContainer = __webpack_require__(28);var _videoContainer2 = _interopRequireDefault(_videoContainer);
var _audioContainer = __webpack_require__(11);var _audioContainer2 = _interopRequireDefault(_audioContainer);
var _jPlayerContainer = __webpack_require__(19);var _jPlayerContainer2 = _interopRequireDefault(_jPlayerContainer);
var _seekBarContainer = __webpack_require__(26);var _seekBarContainer2 = _interopRequireDefault(_seekBarContainer);
var _playBarContainer = __webpack_require__(21);var _playBarContainer2 = _interopRequireDefault(_playBarContainer);
var _bufferBarContainer = __webpack_require__(13);var _bufferBarContainer2 = _interopRequireDefault(_bufferBarContainer);
var _posterContainer = __webpack_require__(24);var _posterContainer2 = _interopRequireDefault(_posterContainer);
var _titleContainer = __webpack_require__(27);var _titleContainer2 = _interopRequireDefault(_titleContainer);
var _fullScreenContainer = __webpack_require__(17);var _fullScreenContainer2 = _interopRequireDefault(_fullScreenContainer);
var _muteContainer = __webpack_require__(20);var _muteContainer2 = _interopRequireDefault(_muteContainer);
var _playContainer = __webpack_require__(22);var _playContainer2 = _interopRequireDefault(_playContainer);
var _repeatContainer = __webpack_require__(25);var _repeatContainer2 = _interopRequireDefault(_repeatContainer);
var _playbackRateBarContainer = __webpack_require__(23);var _playbackRateBarContainer2 = _interopRequireDefault(_playbackRateBarContainer);
var _playbackRateBarValueContainer = __webpack_require__(5);var _playbackRateBarValueContainer2 = _interopRequireDefault(_playbackRateBarValueContainer);
var _volumeBarContainer = __webpack_require__(29);var _volumeBarContainer2 = _interopRequireDefault(_volumeBarContainer);
var _volumeBarValueContainer = __webpack_require__(6);var _volumeBarValueContainer2 = _interopRequireDefault(_volumeBarValueContainer);
var _downloadContainer = __webpack_require__(15);var _downloadContainer2 = _interopRequireDefault(_downloadContainer);
var _durationContainer = __webpack_require__(16);var _durationContainer2 = _interopRequireDefault(_durationContainer);
var _currentTimeContainer = __webpack_require__(14);var _currentTimeContainer2 = _interopRequireDefault(_currentTimeContainer);
var _browserUnsupportedContainer = __webpack_require__(12);var _browserUnsupportedContainer2 = _interopRequireDefault(_browserUnsupportedContainer);
var _constants = __webpack_require__(1);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

var reducer = {
  jPlayers: _reducer2.default };exports.


classes = _constants.classes;exports.getInitialStates = _getInitialStates2.default;exports.reducer = reducer;exports.connect = _connect2.default;exports.JPlayer = _jPlayerContainer2.default;exports.Gui = _guiContainer2.default;exports.SeekBar = _seekBarContainer2.default;exports.PlayBar = _playBarContainer2.default;exports.
BufferBar = _bufferBarContainer2.default;exports.Poster = _posterContainer2.default;exports.Video = _videoContainer2.default;exports.Audio = _audioContainer2.default;exports.Title = _titleContainer2.default;exports.FullScreen = _fullScreenContainer2.default;exports.
Mute = _muteContainer2.default;exports.Play = _playContainer2.default;exports.Repeat = _repeatContainer2.default;exports.PlaybackRateBar = _playbackRateBarContainer2.default;exports.PlaybackRateBarValue = _playbackRateBarValueContainer2.default;exports.
VolumeBar = _volumeBarContainer2.default;exports.VolumeBarValue = _volumeBarValueContainer2.default;exports.Download = _downloadContainer2.default;exports.Duration = _durationContainer2.default;exports.CurrentTime = _currentTimeContainer2.default;exports.BrowserUnsupported = _browserUnsupportedContainer2.default;
