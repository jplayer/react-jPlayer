...
var setOption = exports.setOption = function setOption(key, value, id) {
  return {
...
var play = exports.play = function play(time, id) {
  return {
...
var pause = exports.pause = function pause(time, id) {
  return {
...
var setPlayHead = exports.setPlayHead = function setPlayHead(percent, id) {
  return {
...
var setVolume = exports.setVolume = function setVolume(volume, id) {
  return {
...
var setMute = exports.setMute = function setMute(mute, id) {
  return {
...
var setDuration = exports.setDuration = function setDuration(remainingDuration, id) {
  return {
...
var setPlaybackRate = exports.setPlaybackRate = function setPlaybackRate(playbackRate, id) {
  return {
...
var setLoop = exports.setLoop = function setLoop(loop, id) {
  return {
...
var setFullScreen = exports.setFullScreen = function setFullScreen(fullScreen, id) {
  return {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, _ref3) {
  ...
  return {
    setOption: function setOption(key, value) {
      return dispatch((0, _actions.setOption)(key, value, id));
    },
    pause: function pause(time) {
      return dispatch((0, _actions.pause)(time, id));
    }
  };
};
...
var mergeProps = function mergeProps(_ref4, _ref5, _ref3) {
  ...
  return _extends({
    onClick: function onClick() {
      return dispatch((0, _actions.setFullScreen)(!fullScreen, id));
    }
  }, attributes);
};
...
var mergeProps = function mergeProps(stateProps, _ref3, _ref4) {
  ...
  return _extends({
    setMedia: function setMedia(media) {
      return dispatch((0, _actions.setMedia)(media, id));
    },
    setOption: function setOption(key, value) {
      return dispatch((0, _actions.setOption)(key, value, id));
    }
...
var mergeProps = function mergeProps(_ref4, _ref5, _ref3) {
  ...
  return _extends({
    onClick: function onClick() {
      return dispatch((0, _actions.setMute)(!muted, id));
    }
  }, attributes);
};
...
var mergeProps = function mergeProps(_ref4, _ref5, _ref3) {
  ...
  return _extends({
    onClick: function onClick() {
      return paused ? dispatch((0, _actions.play)(undefined, id)) : dispatch((0, _actions.pause)(undefined, id));
    }
  }, attributes);
};
...
var mergeProps = function mergeProps(_ref4, _ref5, _ref3) {
  ...
  return _extends({
    onClick: function onClick() {
      return dispatch((0, _actions.setLoop)(!loop, id));
    }
  }, attributes);
};
...
var getActions = function getActions(dispatch, id) {
  return {
    ...
    play: function play(time) {
      return dispatch((0, _actions.play)(time, id));
    },
    pause: function pause(time) {
      return dispatch((0, _actions.pause)(time, id));
    },
    setPlayHead: function setPlayHead(percent) {
      return dispatch((0, _actions.setPlayHead)(percent, id));
    },
    setVolume: function setVolume(volume) {
      return dispatch((0, _actions.setVolume)(volume, id));
    },
    setMute: function setMute(mute) {
      return dispatch((0, _actions.setMute)(mute, id));
    },
    setDuration: function setDuration(remainingDuration) {
      return dispatch((0, _actions.setDuration)(remainingDuration, id));
    },
    setPlaybackRate: function setPlaybackRate(playbackRate) {
      return dispatch((0, _actions.setPlaybackRate)(playbackRate, id));
    },
  ...
  return {
    ...
    keyBindings: (0, _lodash2.default)({}, {
      play: {
        key: 80, // p
        fn: function fn() {
          return stateProps.paused ? dispatch((0, _actions.play)(undefined, id)) : dispatch((0, _actions.pause)(undefined, id));
        }
      },
      fullScreen: {
        key: 70, // f
        fn: function fn() {
          return dispatch((0, _actions.setFullScreen)(!stateProps.fullScreen, id));
        }
      },
      mute: {
        key: 77, // m
        fn: function fn() {
          return dispatch((0, _actions.setMute)(!stateProps.muted, id));
        }
      },
      volumeUp: {
        key: 190, // .
      ...
      volumeDown: {
        key: 188, // ,
        fn: function fn() {
          return dispatch((0, _actions.setVolume)(stateProps.volume - 0.1, id));
        }
      },
      loop: {
        key: 76, // l
        fn: function fn() {
          return dispatch((0, _actions.setLoop)(!stateProps.loop, id));
        }
      }
