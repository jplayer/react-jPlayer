(function (global, factory) {
    ...
    exports.default = (0, _reactRedux.connect)(mapStateToProps)(function (_React$Component) {
        ...
        function _class2() {
            ...
            return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _class2.__proto__ || Object.getPrototypeOf(_class2)).call.apply(_ref, [this].concat(args))), _this), _this.onVolumeMaxClick = function () {
        ...
        _createClass(_class2, [{
            ...
            value: function render() {
                return _react2.default.createElement(
                    "a",
                    _extends({ className: _constants.classNames.VOLUME_MAX, onClick: this.props.onVolumeMaxClick }, this.props.attributes),
                    this.props.children
                );
            }
        }]);
