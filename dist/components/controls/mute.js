(function (global, factory) {
    ...
    var Mute = function Mute(props) {
        var onMuteClick = function onMuteClick() {
            return props.dispatch((0, _jPlayerActions.mute)(!props.muted, props.id));
        };
    ...
    exports.default = (0, _reactRedux.connect)(_index.mapStateToProps)((0, _jPlayerConnect2.default)(Mute, mapJPlayerProps));
});