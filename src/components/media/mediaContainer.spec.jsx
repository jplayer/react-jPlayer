...
//     expect(props.setOption).toHaveBeenCalledWith(id, 'currentPercentRelative', 
//        428.57142857142856);
...
//   it(`getCurrentPercentRelative doesnt get the current percent 
//        relative if not seekable`, () => {
//     const { instance } = setup();
