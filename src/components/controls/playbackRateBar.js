...
class PlaybackRateBar extends React.Component {
  ...
  movePlaybackRate = (e) => {
    let offset = getOffset(this.playbackRateBar),
  ...
  render() {
    return (
      <div
        ref={ref => this.playbackRateBar = ref} className={classNames.PLAYBACK_RATE_BAR} onClick={this.onPlaybackRateBarClick} onMouseDown={this.onPlaybackRateMouseDown}
