...
class VolumeBar extends React.Component {
  ...
  moveVolumeBar = (e) => {
    let offset = getOffset(this.volumeBar),
  ...
  render() {
    return (
      <div
        ref={ref => this.volumeBar = ref} className={classNames.VOLUME_BAR} onClick={this.onVolumeBarClick} onMouseDown={this.onVolumeBarMouseDown}
