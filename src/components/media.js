...
import { mapStateToProps, urlNotSupportedError, testPlaybackRate, uaBlocklist, testCanPlayType, absoluteMediaUrls, convertTime, limitValue, updateOption } from '../util/index';
...
class Media extends React.Component {
  constructor(props) {
    ...
    this.events = {
      onProgress: () => {
        ...
        for (let i = 0; i < this.currentMedia.buffered.length; i++) {
        ...
        this.props.dispatch(actions.updateOption('bufferedTimeRanges', bufferedTimeRanges, this.props.id));
      ...
      onRateChange: () => {
        ...
        this.props.dispatch(actions.updateOption('playbackRateText', playbackRateText, this.props.id));
  ...
  updateMediaStatus = () => {
    ...
    this.props.dispatch(actions.updateOption('currentTimeText', convertTime(this.currentMedia.currentTime), this.props.id));
    this.props.dispatch(actions.updateOption('seekPercent', seekPercent, this.props.id));
    this.props.dispatch(actions.updateOption('currentPercentRelative', this.getCurrentPercentRelative(), this.props.id));
    this.props.dispatch(actions.updateOption('currentPercentAbsolute', 100 * this.currentMedia.currentTime / this.currentMedia.duration, this.props.id));
    this.props.dispatch(actions.updateOption('currentTime', this.currentMedia.currentTime, this.props.id));
    this.props.dispatch(actions.updateOption('remaining', remaining, this.props.id));
    this.props.dispatch(actions.updateOption('duration', this.currentMedia.duration, this.props.id));
    this.props.dispatch(actions.updateOption('playbackRate', this.currentMedia.playbackRate, this.props.id));
  ...
  componentDidMount() {
    this.props.dispatch(actions.updateOption('playbackRateEnabled', testPlaybackRate(this.currentMedia), this.props.id));
  }
  render() {
    return (
