...
export default WrappedComponent => connect(mapStateToProps, mapDispatchToProps)(
    class JPlaylist extends React.PureComponent {
      ...
      next = () => {
        const index = (this.props.current + 1 < this.props.playlist.length) ? this.props.current + 1 : 0;
      ...
      previous = () => {
        const index = (this.props.current - 1 >= 0) ? this.props.current - 1 : this.props.playlist.length - 1;
